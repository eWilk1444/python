...
print(f"\n{kg_amount_1} kilogram(s) is about {lbs_1:.2f} pounds")
print(f"{kg_amount_2} kilogram(s) is about {lbs_2:.2f} pounds")
print(f"{kg_amount_3} kilogram(s) is about {lbs_3:.2f} pounds")
print(f"{kg_amount_4} kilogram(s) is about {lbs_4:.2f} pounds", "\n")
